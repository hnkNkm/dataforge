...
- [x] テーブルコンポーネント
- [x] ページネーション
- [x] ソート機能（カラムヘッダークリックでソート、数値・日付・文字列対応）
- [x] データ型別表示
- [x] CSVエクスポート（BOM付きUTF-8、Excel対応）
...
### Sprint 7-8: データベースエクスプローラー (3週間) ✅ 完了
- [x] データベース階層表示
- [x] テーブル/ビュー一覧
- [x] カラム情報表示
- [x] インデックス情報（API実装済み、UI修正中 - Issue #7）
- [x] クイックアクション（SELECT生成等）（実装済み、ドロップダウン修正中 - Issue #7）
- [x] メタデータキャッシュ（5分キャッシュ実装済み）
